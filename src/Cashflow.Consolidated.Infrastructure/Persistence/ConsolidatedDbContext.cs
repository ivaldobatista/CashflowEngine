...
public class ConsolidatedDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DailyBalance>().HasIndex(b => b.Date).IsUnique(); // Ensures one record per day
        modelBuilder.Entity<DailyBalance>().Property(b => b.Balance).HasColumnType("decimal(18, 2)");
    }
}